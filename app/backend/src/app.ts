...
import HomeLeaderBoard from './routes/HomeLeaderboard';
import AwayLeaderboard from './routes/AwayLeaderboard';
...
class App {
  ...
  private initRoutes(): void {
    ...
    this.app.use('/leaderboard', HomeLeaderBoard);
    this.app.use('/leaderboard', AwayLeaderboard);
